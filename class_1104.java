...
// $FF: renamed from: in
public class class_1104 extends class_1099 {

   // $FF: renamed from: f boolean
   private boolean field_5786;
   // $FF: renamed from: g java.lang.String
   private static final String field_5787;
   // $FF: renamed from: i java.lang.String[]
   private static final String[] field_5788;
   ...
   public void method_6243(int var1, Random var2, class_1206 var3, int var4) {
   ...
   // $FF: renamed from: b (java.util.List, java.util.Random, int, int, int, int, int) in
   public static class_1104 method_6244(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if(method_6234(var7) && class_1094.method_6201(var0, var7) == null) {
         var10000 = new class_1104;
         var10000.method_6243(var6, var1, var7, var5);
      } else {
         var10000 = null;
      }
   ...
   public boolean method_6198(ahb var1, Random var2, class_1206 var3) {
      ...
      this.method_6211(var1, var3, 1, 2, 4, 4, 5, 4, class_1192.field_6137, class_1192.field_6137, false);
      ...
      if(var4 != null) {
         label44: {
            if(this.field_5786) {
               ...
               var6 = this.method_6204(1, 3);
               int var7 = this.method_6206(1, 3);
               ...
               if(var8 != 0) {
                  this.field_5786 = false;
                  this.method_6219(var1, var3, var2, 1, 2, 3, field_5778, 2 + var2.nextInt(4));
               }
            }
   ...
   static void method_6222() {
      ...
      int var3 = 0;
      String var2 = "*jÄ*NþÜÚJÞY6ß";
      int var4 = "*jÄ*NþÜÚJÞY6ß".length();
      char var1 = 5;
      int var0 = -1;
      ...
      while(true) {
         ...
         while(true) {
            ...
            if(var10003 <= var6) {
               ...
               if((var0 += var1) >= var4) {
                  field_5788 = var5;
                  String[] var10 = field_5788;
                  field_5787 = "CL_00000463";
                  return;
               }
