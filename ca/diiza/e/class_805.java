...
// $FF: renamed from: ca.diiza.e.b
public class class_805 extends class_689 implements class_12 {

   // $FF: renamed from: at int
   private int field_3755;
   // $FF: renamed from: au int
   private int field_3756;
   // $FF: renamed from: av int
   private int field_3757;
   // $FF: renamed from: aw aji
   private aji field_3758;
   // $FF: renamed from: ax int
   private int field_3759;
   // $FF: renamed from: ay boolean
   private boolean field_3760;
   // $FF: renamed from: az int
   public int field_3761;
   // $FF: renamed from: aA int
   public int field_3762;
   // $FF: renamed from: aB sa
   public class_689 field_3763;
   // $FF: renamed from: aC int
   private int field_3764;
   // $FF: renamed from: aD int
   private int field_3765;
   // $FF: renamed from: aE double
   private double field_3766;
   // $FF: renamed from: aF int
   private int field_3767;
   // $FF: renamed from: aG java.lang.String
   private static final String field_3768;
   // $FF: renamed from: aH boolean
   private static boolean field_3769;
   // $FF: renamed from: db java.lang.String[]
   private static final String[] field_3770;
   ...
   public void method_4706(ahb var1, class_752 var2, class_752 var3, float var4, float var5) {
      boolean var10000 = method_4715();
      super.method_3847(var1);
   ...
   public void method_4707(ahb var1, class_752 var2, float var3) {
      boolean var10000 = method_4714();
      super.method_3847(var1);
   ...
   public void method_3856() {
      ...
      label445: {
         label455: {
            var18 = var27.field_2990.getBlock(this.field_3755, this.field_3756, this.field_3757);
            aji var29 = var18;
            if(var1) {
               ...
               var18.method_2486(this.field_2990, this.field_3755, this.field_3756, this.field_3757);
               var29 = var18;
            }

            class_1343 var3 = var29.method_2452(this.field_2990, this.field_3755, this.field_3756, this.field_3757);
            ...
            if(var33 != 0) {
               this.field_3760 = true;
            }
         }

         var33 = this.field_3762;
      }
      ...
      label457: {
         if(var1) {
            ...
            var33 = this.field_3760;
         }

         if(var33 != 0) {
            label418: {
               int var19 = this.field_2990.method_33(this.field_3755, this.field_3756, this.field_3757);
               if(var1) {
                  if(var18 == this.field_3758) {
                     label414: {
                        label459: {
                           var33 = var19;
                           int var10001 = this.field_3759;
                           if(var1) {
                              if(var19 != this.field_3759) {
                                 break label414;
                              }
            ...
            if(var10 < var7.size()) {
               ...
               if(var1) {
                  label463: {
                     ...
                     if(var10000 && (var12 != this.field_3763 || this.field_3765 >= 5)) {
                        var11 = 0.3F;
                           ...
                           label346: {
                              label466: {
                                 ...
                                 if(var1) {
                                    ...
                                    var10000 = this.field_3763 instanceof class_792;
                                 }
                                 ...
                                 if(var1) {
                                    ...
                                    var10000 = ((class_792)this.field_3763).method_4583(var21);
                                 }
               ...
               label467: {
                  ...
                  if(var34.field_4218 != null) {
                     ...
                     label319: {
                        ...
                        var24 = class_1715.method_9567((double)var22 * this.field_3766);
                        var33 = this.method_4712();
                        if(var1) {
                           if(var33 == 0) {
                              break label319;
                           }
                     ...
                     label313: {
                        ...
                        var27 = this;
                        if(var1) {
                           if(this.field_3763 == null) {
                              var25 = class_1691.method_9329(this, this);
                              break label313;
                           }
                        ...
                        var25 = class_1691.method_9329(var27, this.field_3763);
                     }
                                       ...
                                       if(var10000) {
                                          ...
                                          label474: {
                                             ...
                                             if(var33 > 0) {
                                                ...
                                                if(var23 > 0.0F) {
                                                   var5.field_4218.method_3894(this.field_2997 * (double)this.field_3767 * 0.6000000238418579D / (double)var23, 0.1D, this.field_2999 * (double)this.field_3767 * 0.6000000238418579D / (double)var23);
                                                }
                                             }

                                             var36 = this.field_3763;
                                          }
                                          ...
                                          if(var1) {
                                             label253: {
                                                if(var36 != null) {
                                                   ...
                                                   if(this.field_3763 instanceof class_752) {
                                                      class_980.method_5649(var16, this.field_3763);
                                                      class_980.method_5650((class_752)this.field_3763, var16);
                                                   }
                                                }
                                          ...
                                          if(var36 != null) {
                                             ...
                                             if(var5.field_4218 != this.field_3763) {
                                                ...
                                                if(var10000) {
                                                   var10000 = this.field_3763 instanceof class_793;
                                                   if(!var1) {
                                                      break label290;
                                                   }

                                                   if(var10000) {
                                                      class_1684 var37 = ((class_793)this.field_3763).field_3654;
                  ...
                  this.field_3755 = var5.field_4213;
                  this.field_3756 = var5.field_4214;
                  this.field_3757 = var5.field_4215;
                  this.field_3758 = this.field_2990.getBlock(this.field_3755, this.field_3756, this.field_3757);
                  this.field_3759 = this.field_2990.method_33(this.field_3755, this.field_3756, this.field_3757);
                  ...
                  this.field_3760 = true;
                  this.field_3762 = 7;
                  this.method_4711(false);
                  var27 = this;
                  if(!var1) {
                     break label334;
                  }

                  if(this.field_3758.method_2424() != awt.field_4170) {
                     this.field_3758.method_2498(this.field_2990, this.field_3755, this.field_3756, this.field_3757, this);
                  }
               }
   ...
   public void method_3909(class_1583 var1) {
      String[] var3 = field_3770;
      var1.method_8666("xTile", (short)this.field_3755);
      var1.method_8666("yTile", (short)this.field_3756);
      var1.method_8666("zTile", (short)this.field_3757);
      boolean var10000 = method_4715();
      var1.method_8666("life", (short)this.field_3764);
      var1.method_8665("inTile", (byte)aji.method_2415(this.field_3758));
      var1.method_8665("inData", (byte)this.field_3759);
      var1.method_8665("shake", (byte)this.field_3762);
      boolean var2 = var10000;
      int var10002 = this.field_3760;
      if(!var2) {
         var10002 = this.field_3760?1:0;
      }

      var1.method_8665("inGround", (byte)var10002);
      var3 = field_3770;
      var1.method_8665("pickup", (byte)this.field_3761);
      var1.initGui0("damage", this.field_3766);
   }

   // $FF: renamed from: a (ro) void
   public void method_3908(class_1583 var1) {
      String[] var3 = field_3770;
      this.field_3755 = var1.method_8680("xTile");
      this.field_3756 = var1.method_8680("yTile");
      boolean var2 = method_4715();
      this.field_3757 = var1.method_8680("zTile");
      this.field_3764 = var1.method_8680("life");
      this.field_3758 = aji.method_2416(var1.initGui9("inTile") & 255);
      this.field_3759 = var1.initGui9("inData") & 255;
      this.field_3762 = var1.initGui9("shake") & 255;
      int var10001 = var1.initGui9("inGround");
      if(!var2) {
         var10001 = var10001 == 1?1:0;
      }

      this.field_3760 = (boolean)var10001;
      var3 = field_3770;
      boolean var10000 = var1.initGui8("damage", 99);
      if(!var2) {
         if(var10000) {
            this.field_3766 = var1.method_8684("damage");
         }
      ...
      if(!var2) {
         if(var10000) {
            var3 = field_3770;
            this.field_3761 = var1.initGui9("pickup");
            if(!var2) {
               return;
            }
         }
   ...
   public void method_3892(class_792 var1) {
      ...
      if(!var2) {
         label38: {
            if(this.field_3761 == 1) {
               class_666 var5 = var1.field_3616;
               add var10001 = new add;
               var10001.method_3725(class_1010.field_5350, 1);
   ...
   public void method_4708(double var1) {
      this.field_3766 = var1;
   }

   // $FF: renamed from: a () double
   public double method_4709() {
      return this.field_3766;
   }

   // $FF: renamed from: a (int) void
   public void method_4710(int var1) {
      this.field_3767 = var1;
   }
   ...
   public void method_4711(boolean var1) {
      byte var3;
      label16: {
         boolean var10000 = method_4714();
   ...
   public static void method_4713(boolean var0) {
      field_3769 = var0;
   }

   // $FF: renamed from: d () boolean
   public static boolean method_4714() {
      return field_3769;
   }

   // $FF: renamed from: e () boolean
   public static boolean method_4715() {
      boolean var0 = method_4714();
      return !var0;
   }

   // $FF: renamed from: <clinit> () void
   static void method_4716() {
