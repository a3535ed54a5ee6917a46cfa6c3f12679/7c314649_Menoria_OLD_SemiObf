...
// $FF: renamed from: ca.diiza.f.i
public class class_161 extends bcb {

   // $FF: renamed from: <init> (int, int, int) void
   public void method_848(int var1, int var2, int var3) {
   ...
   public void method_750(bao var1, int var2, int var3) {
      ...
      this.method_658(this.field_447, this.field_448, 20, var6, this.field_445, this.field_446);
   }
}
