...
// $FF: renamed from: ca.diiza.f.j
public class class_160 extends bcb {

   // $FF: renamed from: <init> (int, int, int) void
   public void method_847(int var1, int var2, int var3) {
      super.method_748(var1, var2, var3, 36, 36, "");
   }
   ...
   public void method_750(bao var1, int var2, int var3) {
      ...
      this.method_658(this.field_447, this.field_448, 55, var6, this.field_445, this.field_446);
   }
}
